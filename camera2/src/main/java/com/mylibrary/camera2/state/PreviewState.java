package com.mylibrary.camera2.state;

import android.graphics.Bitmap;
import android.view.Surface;
import android.view.SurfaceHolder;

import com.mylibrary.camera2.CameraInterface;
import com.mylibrary.camera2.JCameraView;
...
class PreviewState implements State {
    ...
    public void restart(SurfaceHolder holder, float screenProp) {
        CameraInterface.getInstance().restart(holder,screenProp);
    }
