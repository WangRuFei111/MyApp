...
import com.mylibrary.camera2.util.AngleUtil;
import com.mylibrary.camera2.util.CameraParamUtil;
import com.mylibrary.camera2.util.CheckPermission;
import com.mylibrary.camera2.util.DeviceUtil;
...
//        mCamera = Camera.open();
    ...
    public void restart(SurfaceHolder holder, float screenProp){
        doStopPreview();
        doStartPreview(holder, screenProp);
    }
